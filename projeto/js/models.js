let modelsJson = [
    ...
    {id:9, name:'A321 neo' , img: 'a321.webp' ,price:[129.90,179.00,229.00], sizes:['1/75','1/40','1/32'], description:'Avião comercial internacional e nacional usado pelas companhias'},
    {id:10, name:'787-8' , img: '787.jpg' ,price:[179.90,199.00,289.00], sizes:['1/75','1/40','1/32'], description:'Avião comercial internacional e nacional usado pelas companhias'},
    {id:11, name:'a330' , img: 'img/a330.jpg' ,price:[149.90,180.00,279.00], sizes:['1/75','1/40','1/32'], description:'Avião comercial internacional e nacional usado pelas companhias'},
    {id:12, name:'a380' , img: 'img/a380.jpg',price:[179.00,250.00,300.00], sizes:['1/75','1/40','1/32'], description:'Avião comercial internacional e nacional usado pelas companhias'},
];